...
function FormDropdown(props) {
  ...
  return (
    <div>
        <select name={name} {...field} className={"bg-[#F7F7F7] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-9 focus:outline-0 focus:border-[#F7F7F7] " + dropdownStyle}>
