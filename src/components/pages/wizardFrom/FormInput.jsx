...
function FormInput(props) {
  ...
  return (
    <div>
      ...
      <Field name={fieldName} label={label} className=" border-2 border-blue-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 mt-2 focus:outline-0" placeholder={placeholder}></Field>
